            ...
            case 2:
                ...
                return [4 /*yield*/, prisma.playerStats.upsert({
                        ...
                        update: {
                            ...
                            gamesDrawn: { increment: data.match_outcome === "Draw" ? 1 : 0 },
                            kda: existingPlayer
                        ...
                        create: {
                            ...
                            headshotPercentage: (data.headshots / Math.max(1, data.kills)) * 100,
                            kills: data.kills,
                            deaths: data.deaths,
                            ...
                            roundsWinPercentage: (data.rounds_won / Math.max(1, data.total_rounds)) * 100,
                            damage: data.damage,
                        },
                    })];
            case 3:
