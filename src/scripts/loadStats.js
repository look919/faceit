...
var main = function () { return __awaiter(void 0, void 0, void 0, function () {
    var rawData, stats, mapPlayed, _loop_1, _i, _a, _b, steamId, data;
    return __generator(this, function (_c) {
        switch (_c.label) {
                        ...
                        switch (_d.label) {
                            ...
                            case 1:
                                ...
                                countableStats = {
                                    ...
                                    entryKillRating: collectableStats.entryFrags / Math.max(1, collectableStats.entryDeaths),
            ...
            case 3:
                ...
                return [3 /*break*/, 1];
            case 4:
                console.log("Loaded stats from map: ".concat(mapPlayed, "."));
                return [2 /*return*/];
        }
    });
}); };
